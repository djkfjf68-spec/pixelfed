...
<head>
	...
	<meta property="og:logo" content="{{ url('/img/bix-icon-color.png')}}" />
...
<head>
	...
	<title>{{ $title ?? config_cache('app.name', 'Bix') }}</title>
	<link rel="manifest" href="/manifest.json">
	<meta property="og:logo" content="{{ url('/img/bix-icon-color.png')}}" />
	<meta property="og:site_name" content="Bix">
	<meta property="og:title" content="{{ $ogTitle ?? $title ?? config_cache('app.name', 'Bix') }}">
	<meta property="og:type" content="{{ $ogType ?? 'article' }}">
	<meta property="og:url" content="{{url(request()->url())}}">
	@stack('meta')
