...
return [
    ...
    'pixelfed_is_an_image_sharing_platform_etc'             => 'Bix is a modern social media platform with short videos and photo sharing, an ethical alternative to centralized platforms.', // this is actually never used because it's a fallback for config_cache('app.description') and config_cache('app.short_description') which seem to be impossible to set to empty when saved via /admin/settings?t=branding
    ...
    'open_source_in_pixelfed'                               => 'Open source in Bix',
];